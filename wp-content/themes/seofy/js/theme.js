...
//Adding padding to .header_sticky_shadow if SHOW #recallbar
if( jQuery('div').is('#recallbar') ){
	jQuery('.header_sticky_shadow').addClass('padding-top-36');
}
else{
	jQuery('.header_sticky_shadow').removeClass('padding-top-36');
}