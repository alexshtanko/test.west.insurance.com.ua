jQuery(document).ready(function(){
    ...
    function Start(){
        ...
        if( jQuery('div').is('.js-select-insurance-blank-type') ){
            ...
            jQuery('body').on('click', '.js-select-insurance-blank-type li', function(){
                ...
                jQuery('input[name=blank_type_id]').val(blank_type_id);
    ...
    function MedicalInsuranceBlankSeries(blank_id, company_id = 1){
        ...
        blank_type_id = jQuery('input[name="blank_type_id"]').val()*1;
    ...
    function GetMedicalInsurance(){
        jQuery('body').on('click', '.js-get-insurance', function(e){
            ...
            if( companyId == 2 )
            {
                ...
                jQuery(".user-profile-line-1").eq(0).find('.vc_col-lg-4').eq(0).addClass('vc_col-lg-2');
                jQuery(".user-profile-line-1").eq(0).find('.vc_col-lg-4').eq(0).removeClass('vc_col-lg-4');
                ...
                jQuery(".user-profile-line-1").eq(0).find('.vc_col-lg-2').eq(2).after('<div class="vc_col-lg-2 js-sex"><div class="inpt-wrapper"><label class="label-1 label-required">Стать</label><div class="dd-list-wrapper"><input class="dd-hide-filed" name="medical_sex" id="medical_sex" type="text" readonly="readonly"><div class="dd-arrow"></div><div class="dd-list-input">Оберіть...</div><ul class="dd-list type-of-car" style="display: none;"><li data-value="M">Чоловiча</li><li data-value="W">Жiноча</li></ul></div></div></div>' +
                    '<div class="vc_col-lg-2 js-inn"><div class="inpt-wrapper"><label for="medical_inn" class="label-1">IHH</label><input name="medical_inn" type="text" class="inpt-5 valid" id="medical_inn" aria-invalid="false"></div></div>' +
                    '<div class="vc_col-lg-2 js-eddr"><div class="inpt-wrapper"><label for="medical_eddr" class="label-1">Або ЕДДР</label><input name="medical_eddr" type="text" class="inpt-5 valid" id="medical_eddr" aria-invalid="false"></div></div>');
            }
            else
            {
                ...
                //Уменьшаем размер поля ввода даты начала действия договора
                jQuery(".user-profile-line-1").eq(0).find('.vc_col-lg-2').eq(0).addClass('vc_col-lg-4');
                jQuery(".user-profile-line-1").eq(0).find('.vc_col-lg-2').eq(0).removeClass('vc_col-lg-2');
    ...
    function InsurerRow( id ){
        ...
        // return '<div class="insurer-row"><div class="row"><div class="vc_col-lg-4"><label data-id="insurerLastName" class="label-1" for="insurerLastName">Прiзвище</label><input class="inpt-5" type="text" id="insurerLastName"></div><div class="vc_col-lg-4"><label class="label-1" for="insurerName">Ім\'я</label><input class="inpt-5" type="text" id="insurerName"></div><div class="vc_col-lg-4"><div class="inpt-wrapper"><label class="label-1" for="insurerDate">Дата народження</label><input class="inpt-5 bg-calendar add-data-picker" type="text" id="insurerDate" autocomplete="off" required placeholder="дд.мм.рррр"></div></div></div><div class="row"><div class="vc_col-lg-5"><label class="label-1" for="insurerPassport">Серiя, номер паспорта</label><input class="inpt-5" type="text" id="insurerPassport"></div><div class="vc_col-lg-5"><label class="label-1" for="insurerAddress">Адреса постійного місця проживання</label><input class="inpt-5" type="text" id="insurerAddress"></div><div class="vc_col-lg-2"><button class="btn-1 add-insurer-row js-add-insurer-row">+</button><button class="btn-1 remove-insurer-row js-remove-insurer-row">-</button></div></div></div>';
        return '<div class="insurer-row"><div class="row"><div class="vc_col-lg-4"><div class="inpt-wrapper"><label data-id="insurerLastName" for="insurerLastName'+ id +'" class="label-1">Прiзвище</label><input class="inpt-5 insurer-last-name" id="insurerLastName'+id+'" name="insurerLastName'+id+'" type="text"></div></div><div class="vc_col-lg-4"><div class="inpt-wrapper"><label data-id="insurerName" for="insurerName'+id+'" class="label-1">Ім\'я</label><input class="inpt-5 insurer-name" name="insurerName'+id+'" id="insurerName'+id+'" type="text"></div></div><div class="vc_col-lg-4"><div class="inpt-wrapper"><div class="inpt-wrapper"><label data-id="insurerDate" for="insurerDate'+id+'" class="label-1">Дата народження</label><input class="inpt-5 bg-calendar add-data-picker insurer-date js-insurer-date" data-mask="99.99.9999" name="insurerDate'+id+'" id="insurerDate'+id+'" type="text" autocomplete="off" placeholder="дд.мм.рррр"></div></div></div></div><div class="row"><div class="vc_col-lg-5"><div class="inpt-wrapper"><label data-id="insurerPassport" for="insurerPassport'+id+'" class="label-1">Серiя, номер паспорта</label><input class="inpt-5 insurer-passport" id="insurerPassport'+id+'" name="insurerPassport'+id+'" type="text"></div></div><div class="vc_col-lg-5"><div class="inpt-wrapper"><label data-id="insurerAddress" class="label-1" for="insurerAddress'+id+'">Адреса постійного місця проживання</label><input class="inpt-5 insurer-address" name="insurerAddress'+id+'" id="insurerAddress'+id+'" type="text"></div></div><div class="vc_col-lg-2"><label class="label-1">&nbsp;</label><button class="btn-1 add-insurer-row js-add-insurer-row">+</button><button class="btn-1 remove-insurer-row js-remove-insurer-row">-</button></div></div></div>';
    }
    ...
    function ReinitInsurerRow(){
        ...
        if( rowCount > 0 ){
            ...
            for( count = 0; count < rowCount;  ) {
                ...
                insurerLastName = jQuery('.insurer-row').eq(count).find('.row').eq(0).find('.vc_col-lg-4').eq(0).find('.label-1').attr('data-id');
                jQuery('.insurer-row').eq(count).find('.row').eq(0).find('.vc_col-lg-4').eq(0).find('.label-1').attr('for', insurerLastName + index);
                jQuery('.insurer-row').eq(count).find('.row').eq(0).find('.vc_col-lg-4').eq(0).find('.inpt-5').attr('id', insurerLastName + index);
                jQuery('.insurer-row').eq(count).find('.row').eq(0).find('.vc_col-lg-4').eq(0).find('.inpt-5').attr('name', insurerLastName + index);

                // Row 1 col 2

                insurerName = jQuery('.insurer-row').eq(count).find('.row').eq(0).find('.vc_col-lg-4').eq(1).find('.label-1').attr('data-id');
                jQuery('.insurer-row').eq(count).find('.row').eq(0).find('.vc_col-lg-4').eq(1).find('.label-1').attr('for', insurerName + index);
                jQuery('.insurer-row').eq(count).find('.row').eq(0).find('.vc_col-lg-4').eq(1).find('.inpt-5').attr('id', insurerName + index);
                jQuery('.insurer-row').eq(count).find('.row').eq(0).find('.vc_col-lg-4').eq(1).find('.inpt-5').attr('name', insurerName + index);

                // Row 1 col 3
                insurerDate = jQuery('.insurer-row').eq(count).find('.row').eq(0).find('.vc_col-lg-4').eq(2).find('.label-1').attr('data-id');
                jQuery('.insurer-row').eq(count).find('.row').eq(0).find('.vc_col-lg-4').eq(2).find('.label-1').attr('for', insurerDate + index);
                jQuery('.insurer-row').eq(count).find('.row').eq(0).find('.vc_col-lg-4').eq(2).find('.inpt-5').attr('id', insurerDate + index);
                jQuery('.insurer-row').eq(count).find('.row').eq(0).find('.vc_col-lg-4').eq(2).find('.inpt-5').attr('name', insurerDate + index);


                // Row 2 col 1
                insurerPassport = jQuery('.insurer-row').eq(count).find('.row').eq(1).find('.vc_col-lg-5').eq(0).find('.label-1').attr('data-id');
                jQuery('.insurer-row').eq(count).find('.row').eq(1).find('.vc_col-lg-5').eq(0).find('.label-1').attr('for', insurerPassport + index);
                jQuery('.insurer-row').eq(count).find('.row').eq(1).find('.vc_col-lg-5').eq(0).find('.inpt-5').attr('id', insurerPassport + index);
                jQuery('.insurer-row').eq(count).find('.row').eq(1).find('.vc_col-lg-5').eq(0).find('.inpt-5').attr('name', insurerPassport + index);

                console.log('------------insurerPassport: ' + insurerPassport);

                // Row 2 col 2
                insurerAddress = jQuery('.insurer-row').eq(count).find('.row').eq(1).find('.vc_col-lg-5').eq(1).find('.label-1').attr('data-id');
                jQuery('.insurer-row').eq(count).find('.row').eq(1).find('.vc_col-lg-5').eq(1).find('.label-1').attr('for', insurerAddress + index);
                jQuery('.insurer-row').eq(count).find('.row').eq(1).find('.vc_col-lg-5').eq(1).find('.inpt-5').attr('id', insurerAddress + index);
                jQuery('.insurer-row').eq(count).find('.row').eq(1).find('.vc_col-lg-5').eq(1).find('.inpt-5').attr('name', insurerAddress + index);
