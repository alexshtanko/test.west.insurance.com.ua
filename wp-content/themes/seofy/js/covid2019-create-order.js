    ...
    function ValidateOrderForm(){
        ...
        jQuery('#medicalForm').validate({
            ...
            submitHandler: function(form) {
                ...
                user_citizenship = jQuery('input[name="medical_citizenship"]').val();
                ...
                if( rowCount > 0 ){
                    ...
                    for( count = 0; count < rowCount;  ) {
                        ...
                        insurerCitizenship = jQuery('.insurer-row').eq(count).find('#insurerCitizenship' + index).val();
...
console.log(insurers);
        ...
        jQuery.validator.addMethod("year_limit", function(value, element) {
