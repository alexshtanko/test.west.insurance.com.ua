                    ...
                    <div class="row">
                        <div class="vc_col-lg-12">
                            <div class="step-1">
                                ...
                                <div class="step-one-calc" id="setCalc">
                                    ...
                                    <div class="parameter-three">
                                        ...
                                        <input type="text" class="inpt-2 cities js-cities" placeholder="Введіть місто реєстрації власника">
                            ...
                            <div class="step-4">
                                ...
                                <form action="/plc/m/pay_m-t.php" method="post" id="checkoutForm">
                                    ...
                                    <div class="step-4-body">
                                        ...
                                        <input name="car-selected-addt-contract" id="car-selected-addt-contract" type="hidden" class="inpt-5">
                                    ...
                                    <div class="step-4-footer user-profile-line">
                                        ...
                                        <div class="step-4-footer-bottom">
                                            <div class="row">
                                                <div class="vc_col-lg-12">
                                                    <input type="submit" name="submit" class="btn-get-it" value="Підтвердити укладення">
                                                </div>
                                            </div>
                                        </div>
