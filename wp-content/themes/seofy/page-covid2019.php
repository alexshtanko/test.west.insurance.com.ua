                            ...
                            <div class="js-insurance-form hidden">
                                ...
                                <div class="row user-profile-line-1">
                                    ...
                                    <div class="row user-profile-line-1">
                                        ...
                                        <div class="vc_col-lg-4">
                                            <div class="inpt-wrapper">
                                                <label for="medical_citizenship" class="label-1">Громадянство</label>
                                                <input name="medical_citizenship" type="text" class="inpt-5" id="medicalcitizenship" autocomplete="off">
                                            </div>
                                        </div>
                                ...
                                <div class="row user-profile-line-1">
                                    <div class="vc_col-lg-4">
                                        <div class="add-insurer-wrapper">
                                            ...
                                            <input type="checkbox" name="add-insurer" id="addInserer" checked><label class="js-addInserer-label" for="addInserer" title="Якщо страхувальник та застрахована одна i таж особа, нiчого добавляти не потрiбно." ></label>
...
<!--                                            <input name="medical_date_start" type="text" class="inpt-5 bg-calendar" id="medical_date_start" autocomplete="off" required placeholder="дд.мм.рррр">-->
            ...
            echo '<h1>Ви не увійшли в систему. Будь-ласка авторизуйтеся.</h1>';
        }
    }
    ?>
</div>
