...
if( $current_user->ID ) {
	...
	if ( array_intersect( $allowed_roles, $user->roles ) ) {
		wp_redirect( " https://" . $_SERVER['HTTP_HOST'] . "/get-policy-m" );
	}
}
    ...
    <div class="wgl-container">
        <div class="steps">
            ...
            if(count($service_stop) == 1 && $service_stop[0]->value == 1){
                echo "<h2>Сервіс тимчасово не працює!</h2>";
            }
            else {
                                ...
                                <div class="row">
                                    <div class="vc_col-xs-6">
                                        <div class="inpt-date-wrapepr inpt-date-from">
                                            <input class="inpt-2 bg-calendar" id="termStart" type="text" placeholder="дд.мм.рррр" autocomplete="off" value="<?php echo $dateFrom; ?>">
                                        </div>
                                    </div>
                                    <div class="vc_col-xs-6">
