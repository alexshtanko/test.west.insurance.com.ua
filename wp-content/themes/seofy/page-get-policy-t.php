<?php
/**
* The template for client page
Template Name: Сторінка клієнта (тест)
*
...
if(!isset($_GET['access']) || $_GET['access'] !== "f3kcs2a" ) wp_redirect( " https://".$_SERVER['HTTP_HOST'] );
            ...
            <div class="vc_col-lg-12">
                <div class="step-1">
                    ...
                    <div class="step-one-number" id="setNumber">
                        <h1>Оформити поліс (ТЕСТ)</h1>
                        <div class="step-one-number-inner">
                            <div class="title-silver">Для зареєстрованих в Україні</div>

                            <input type="text" class="inpt-1 car-number" placeholder="AA1234BP" oninput="this.value = this.value.toUpperCase()" />
                    ...
                    <div class="step-one-calc" id="setCalc">
                        ...
                        <div class="parameter-three">
                            ...
                            <input type="text" class="inpt-2 cities js-cities" placeholder="Введіть місто реєстрації">
                            ...
                            <div class="row">
                                <div class="vc_col-xs-6">
                                    <div class="inpt-date-wrapepr inpt-date-from">
                                        <input class="inpt-2 bg-calendar" id="termStart" type="text" readonly="readonly" value="<?php echo $dateFrom; ?>">
                                    </div>
                                </div>
                                <div class="vc_col-xs-6">
                                    <div class="inpt-date-wrapepr inpt-date-to">
                                        <input class="inpt-2 bg-calendar" id="termEnd" type="text" readonly="readonly" value="<?php echo $dateTo; ?>" disabled="disabled">
                                    </div>
                                </div>
                            </div>
                ...
                <div class="step-2">
                    ...
                    <div class="step-2-inner">
                        ...
                        <input class="inpt-2 js-cities js-get-cities" id="get-cities" type="text" placeholder="Введіть місто реєстрації">
                        ...
                        <div class="dateFrom-dateTo">
                            ...
                            <div class="row">
                                <div class="vc_col-xs-6">
                                    <div class="inpt-date-wrapepr inpt-date-from">
                                        <input class="inpt-2 bg-calendar" id="termStartSecond" type="text" readonly="readonly" value="<?php echo $dateFrom; ?>">
                                    </div>
                                </div>
                                <div class="vc_col-xs-6">
                                    <div class="inpt-date-wrapepr inpt-date-to">
                                        <input class="inpt-2 bg-calendar" id="termEndSecond" type="text" readonly="readonly" value="<?php echo $dateTo; ?>" disabled="disabled">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="step-4">
                    ...
                    <form action="/plc/c/pay-t.php" method="post" id="checkoutForm">
                            ...
                            <div class="row flex-box">
                                <div class="vc_col-lg-10">
                                    ...
                                    <div class="policy-check-period">
                                        ...
                                        <input type="text" class="inpt-4" id="policyCheckPeriodStart" value="<?php echo $dateFrom; ?>" readonly="readonly"> -

                                        <input type="text" class="inpt-4" id="policyCheckPeriodEnd" value="<?php echo $dateTo; ?>" readonly="readonly">
                                    </div>
                                </div>
                                <div class="vc_col-lg-2">
                        ...
                        <div class="step-4-body-top">
                            ...
                            <div class="row">
                                <div class="vc_col-lg-12">
                                    ...
                                    <input name="email" class="inpt-5" type="email" placeholder="E-mail" required>
                        ...
                        <div class="step-4-body">
                            <div class="user-personal-data">
                                ...
                                <div class="userData">
                                    ...
                                    <div class="row user-profile-line-1">
                                        <div class="vc_col-lg-4">
                                            ...
                                            <input name="user-surname" type="text" class="inpt-5" id="user-surname" required>
                                        </div>
                                        <div class="vc_col-lg-4">
                                            <label for="user-name" class="label-1">Ім'я</label>
                                            <input name="user-name" type="text" class="inpt-5" id="user-name" required>
                                        </div>
                                        <div class="vc_col-lg-4">
                                            <label for="user-second-name" class="label-1">По-батькові</label>
                                            <input name="user-second-name" type="text" class="inpt-5" id="user-second-name" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row user-profile-line-1">
                                        <div class="vc_col-lg-4">
                                            ...
                                            <input name="user-date" type="text" class="inpt-5 bg-calendar" id="user-date" readonly="readonly" required>
                                        </div>
                                        <div class="vc_col-lg-4">
                                            <label for="user-inn" class="label-1">ІНН</label>
                                            <input name="inn" type="number" class="inpt-5" id="user-inn" minlength="10" maxlength="10" required>
                                        </div>
                                        <div class="vc_col-lg-4">
                                            <label for="user-phone" class="label-1">Мобільний</label>
                                            <input name="user-phone" type="tel" class="inpt-5" id="user-phone" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="companyData">
                                    ...
                                    <div class="row user-profile-line flex-box">
                                        <div class="vc_col-xs-12 vc_col-lg-12">
                                            <div class="title-1"><i class="fa fa-user-o" aria-hidden="true"></i> Дані про компанію</div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row company-profile-line-1">
                                        <div class="vc_col-lg-4">
                                            ...
                                            <input name="company-name" type="text" class="inpt-5" id="company-name" required>
                                        </div>

                                        <div class="vc_col-lg-4">
                                            <label for="company-inn" class="label-1">ЄДРПОУ</label>
                                            <input name="company-inn" type="number" class="inpt-5" id="company-inn" minlength="8" maxlength="14" required>
                                        </div>
                            ...
                            <div class="user-document user-profile-line">
                                <div class="row flex-box">
                                    ...
                                    <div class="vc_col-lg-4 radio-btn-wrapper js-document-wrapper">
                                        ...
                                        <div class="dd-list-wrapper">
                                            <input name="document-type" class="dd-hide-filed selected-document" type="text" readonly="readonly">
                                            <div class="dd-arrow"></div>
                                            <div class="dd-list-input dd-list-input-docs">Оберіть...</div>
                                            <ul class="dd-list type-of-documents">
                                                <li data-type-doc="PASSPORT" data-for-privileged="false">Паспорт</li>
                                                <li data-type-doc="ID_PASSPORT" data-for-privileged="false">ID-паспорт</li>
                                                <li data-type-doc="DRIVING_LICENSE" data-for-privileged="false">Посвідчення водія</li>
                                                <li data-type-doc="FOREIGN_PASSPORT" data-for-privileged="false">Паспорт іноземця</li>
                                                <li data-type-doc="RESIDENCE_PERMIT" data-for-privileged="false">Вид на проживання</li>
                                                <li data-type-doc="PENSION_CERTIFICATE" data-for-privileged="true">Пенсійне посвідчення</li>
                                                <li data-type-doc="DISABILITY_CERTIFICATE" data-for-privileged="true">Посвідчення про інвалідність</li>
                                                <li data-type-doc="VETERAN_CERTIFICATE" data-for-privileged="true">Посвідчення учасника війни</li>
                                                <li data-type-doc="CHERNOBYL_CERTIFICATE" data-for-privileged="true">Чорнобильське посвідчення</li>
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div class="row user-profile-line-1">
                                    ...
                                    <div class="user-document-passport" id="userDocumentPassport">
                                        ...
                                        <div class="inputsIdPassport">
                                            <div class="vc_col-lg-2">
                                                <label>Запис №</label>
                                                <input name="document-record-number" type="text" class="inpt-5" required>
                                            </div>

                                            <div class="vc_col-lg-2">
                                                <label>Документ №</label>
                                                <input name="document-number" type="number" class="inpt-5"required>
                                            </div>

                                            <div class="vc_col-lg-4">
                                                <label>Орган, що видав</label>
                                                <input name="document-issued" type="text" class="inpt-5" required>
                                            </div>

                                            <div class="vc_col-lg-2">
                                                <label>Дата видачі</label>
                                                <input name="document-data" type="text" class="inpt-5 bg-calendar" id="document-data" readonly="readonly" required>
                                            </div>

                                            <div class="vc_col-lg-2">
                                                <label>Дійсний до</label>
                                                <input name="document-data-untill" type="text" class="inpt-5 bg-calendar" id="document-data-untill" readonly="readonly" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="inputsOtherDocument">
                                            <div class="vc_col-lg-2">
                                                <label>Серія</label>
                                                <input name="passport-series" type="text" class="inpt-5" maxlength="3" required>
                                            </div>

                                            <div class="vc_col-lg-2">
                                                <label>Номер</label>
                                                <input name="passport-number" type="number" class="inpt-5"required>
                                            </div>

                                            <div class="vc_col-lg-6">
                                                <label>Ким виданий</label>
                                                <input name="passport-issued" type="text" class="inpt-5" required>
                                            </div>

                                            <div class="vc_col-lg-2">
                                                <label>Коли виданий</label>
                                                <input name="passport-data" type="text" class="inpt-5 bg-calendar" id="passport-data" readonly="readonly" required>
                                            </div>
                                        </div>
                            ...
                            <div class="user-location user-profile-line">
                                ...
                                <div class="row">
                                    <div class="vc_col-lg-4">
                                        ...
                                        <input name="user-adress" type="text" class="inpt-5" placeholder="" required>
                                    </div>
                                    <div class="vc_col-lg-4">
                                        <label class="label-1">Назва вулиці</label>
                                        <input name="user-street" type="text" class="inpt-5" placeholder="" required>
                                    </div>
                                    <div class="vc_col-lg-2">
                            ...
                            <div class="user-transport user-profile-line">
                                ...
                                <div class="row">
                                    <div class="vc_col-lg-4">
                                        ...
                                        <input name="car-number" type="text" class="inpt-5" placeholder="" oninput="this.value = this.value.toUpperCase()" required>
                                    </div>
                                    <div class="vc_col-lg-4">
                                        <label class="label-1">Марка </label>
                                        <input name="car-brand" type="text" class="inpt-5" placeholder="" required>
                                    </div>
                                    <div class="vc_col-lg-4">
                                        <label class="label-1">Модель </label>
                                        <input name="car-model" type="text" class="inpt-5" placeholder="" required>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="vc_col-lg-4">
                                        ...
                                        <input name="car-chassis" type="text" class="inpt-5" placeholder="" oninput="this.value = this.value.toUpperCase()" minlength="5" maxlength="17" required>
                                    </div>
                                    <div class="vc_col-lg-4">
                                        <label class="label-1">Рік випуску </label>
                                        <input name="car-year" type="number" class="inpt-5" placeholder="" maxlength="4" required>
                                    </div>
                                    <div class="engineWeight">
                                        <div class="vc_col-lg-4">
                                            <label class="label-1">Об'єм двигуна </label>
                                            <input name="car-engine" type="number" class="inpt-5" placeholder="" minlength="3" maxlength="4" required>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <input name="car-contr-agent" id="car-contr-agent" type="hidden" class="inpt-5">
                            <input name="car-adress" id="car-adress" type="hidden" class="inpt-5">
                            <input name="car-adress-code" id="car-adress-code" type="hidden" class="inpt-5">

                            <input name="car-taxi" id="car-taxi" type="hidden" class="inpt-5">

                            <input name="car-selected-osago" id="car-selected-osago" type="hidden" class="inpt-5">
                            <input name="car-selected-franchise" id="car-selected-franchise" type="hidden" class="inpt-5">
                            <input name="car-selected-dcv" id="car-selected-dcv" type="hidden" class="inpt-5">
                        ...
                        <div class="step-4-footer user-profile-line">
                            <div class="step-4-footer-top">
                                <div class="row">
                                    <div class="vc_col-lg-12">
                                        <input type="checkbox" id="agree" name="agree"><label for="agree">Я приймаю умови <a href="/public-offer/" target="_blank">договору публічної оферти</a>, підтверджую достовірність всіх введених даних.</label>
                                    </div>
                                </div>
                            </div>
                            <div class="step-4-footer-bottom">
                                <div class="row">
                                    <div class="vc_col-lg-12">
                                        <input type="submit" name="submit" class="btn-get-it" value="Сплатити">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="vc_col-lg-12">
                                        <div class="credit-cart">
                                            <img class="cart-visa" src="<?php echo bloginfo('template_url'); ?>/img/visa.svg" alt="">
                                            <img src="<?php echo bloginfo('template_url'); ?>/img/master-cart.svg" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
