...
if(!isset($_GET['access']) || $_GET['access'] !== "cn4dW91j" ) wp_redirect( " https://".$_SERVER['HTTP_HOST'] );
    ...
    <div class="epol-modal-wrapper-inner">
        <div class="epol-modal">
            ...
            <div class="epol-modal-body">
                <form class="js-medical-customer-form" action="/plc/c/pay_medical-t.php" method="POST">
