...
if( !defined('ACCESSCNST' ) )
{
    ...
    $status = $order_data->export_excell( $order_id );
...
//        $spreadsheet = $reader->load("/inter_plus.xlsx");
        $spreadsheet = $reader->load(__DIR__ . "/inter_plus.xlsx");
        ...
        $novaAssistance->setPath('5_inter_plus/nova_assistance.png'); // put your path and image here
        ...
        $interPlusLogo->setPath('5_inter_plus/inter_plus_logo.png'); // put your path and image here
        ...
        $stamp->setPath('5_inter_plus/stamp.png'); // put your path and image here
        $stamp->setWidth(170);
        ...
        $sign->setPath('5_inter_plus/sign.png'); // put your path and image here
        $sign->setWidth(98);
