jQuery(document).ready(function($) {
	...
	function RemoveNumberOfBlanks(){
		...
		$('body').on('click', '.js-remove-number-of-blanks', function(e){
            ...
            console.log(blank_id);
           
            if( blank_id != '' ){
                   
                //Создаем данные для передачи
                var data = {
                    action: 'insuranceadminremovenumberofblanks',
                    nonce: insuranceAdminRemoveNumberOfBlanks.nonce,
                    id: blank_id,
                };
                ...
                //Отправляем данные
                var jqXHR = $.post( insuranceAdminRemoveNumberOfBlanks.ajaxurl, data, function(response) {
