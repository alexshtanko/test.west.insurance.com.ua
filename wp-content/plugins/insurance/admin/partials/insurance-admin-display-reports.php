...
//					$ratePrice          = round( $ratePrice, 2 );
				...
				$excelData[] = array($i, $blankSeries.$blankNumber, $dateAdded, $dateFrom, $dateTo, $countDays, $lastName." ".$name, $passport, $birthday, $ratePrice, $cashback, $summCashback, $user->data->display_name, $companyTitle, $programTitle, $numberBlankComment, $blank_type_text, $orderStatus);
				$i++;
			}
		}
