...
<div class="wrap order_list_page">
    ...
    <div class="order-form-filter wp-core-ui">
        <form name="form_order_list" id="formOrderList" method="POST">
            ...
            <input class="inpt-position w-140" name="order_number" id="insuranceBlankNumber" type="number" placeholder="Номер бланку">
...
<div class="insurance-modal-wrapper" id="insuranceModal">
    <div class="insurance-modal">
        <div class="insurance-modal-header">
            <span class="insurance-modal-header-title js-insurance-modal-header-title"></span>
            <div class="insurance-modal-close js-insurance-modal-close"><i class="fa fa-close"></i></div>
        </div>
        <div class="insurance-modal-body js-insurance-modal-body">

        </div>
    </div>
</div>
<style>
    .insurance-modal-wrapper.show .insurance-modal {
        max-width: 480px;
        left: 5%;
    }
