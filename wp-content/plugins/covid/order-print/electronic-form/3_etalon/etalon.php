...
//    $templateProcessor = new TemplateProcessor($_SERVER['DOCUMENT_ROOT']."wp-content/plugins/covid/order-print/electronic-form/3_etalon/template.docx");

    $templateProcessor->setValue('orderNumber', "14600-042-".$blank_number_print);
