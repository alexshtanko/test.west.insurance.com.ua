...
<div class="wrap">
    ...
    <?php if ($companies) : ?>
        <?php
        echo '<p><a href="' . admin_url('admin.php?page=covid-blank-to-manager') . '" class="blank-to-manager">
...
<!--                </select>-->
        ...
        <form action="" method="POST" id="manager_search">
            ...
            <div style="display: inline-block; vertical-align:top">
                ...
                <select name="blank_series" class="inpt-2covidadmingetmanagerofblank">
    ...
    <?php else : ?>
        На даний момент не додано жодної компанії, перейдіть в розділ <a
                href="/wp-admin/admin.php?page=covid-company">Компанії</a> щоб додати її.
    <?php endif; ?>
