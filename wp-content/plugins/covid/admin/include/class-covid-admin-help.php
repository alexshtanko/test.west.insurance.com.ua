...
class Covid_Admin_Help
{
    ...
    public function company_price_coeficient( $company_id, $rate_price, $insurer_age_coefficient = 1, $rate_price_coefficient = 1 )
    {
        ...
        $insurer_rate_price = $rate_price * $insurer_age_coefficient * $rate_price_coefficient;
     ...
     */
    public  function update_user_covid_visible_company( $role = 'user_manager', $company_id = 0 )
    {
        ...
        if( $company_id )
        {
            ...
            if( $users )
            {
                foreach ( $users as $user ) {
                    ...
                    $st = update_user_meta( $user->ID, 'user_covid_company_visible_status_' . $company_id, 1);
