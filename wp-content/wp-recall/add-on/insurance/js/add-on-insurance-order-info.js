jQuery(document).ready(function($) {
	...
	function OrderMoreInfo(){
		...
		$('body').on('click', '.js-get-order-info', function(e){
    ...
    function RemovalRequest(){
        ...
        $('body').on('click', '.js-insurance-removal-request', function(e){
    ...
    function SendEmail(){
        ...
        $('body').on('click', '#sendRemovalRequest', function(e){
            ...
            blank_number = base.attr('data-blank-number');
            blank_series = base.attr('data-blank-series');
            status_text = $("#removalRequestStatus option:selected" ).text();

            console.log('order_id: ' + order_id + ' status: ' + status + ' comment: ' +comment + " unicue_code: "
                + unicue_code + ' blank_number: ' + blank_number + ' blank_series: ' + blank_series + ' status_text' + status_text);
